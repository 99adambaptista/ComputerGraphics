...
//var p = midPointLine(0, 100, 200, 512);
//var out = "";
...
//var p = bezierCurve(10, 20, 100, 40, 30, 30, 20, 70);
//var out = "";
//for (var i = 0; i < p.length; i++) {
//    out += "(" + p.x[i] + ", " + p.y[i] + ")\n";
//}
...
//var p = hermiteCurve(10, 20, 100, 40, 30, 30, 20, 70);
//var out = "";
//for (var i = 0; i < p.length; i++) {
//    out += "(" + p.x[i] + ", " + p.y[i] + ")\n";
//}
//console.log(out, p.length);
...
//var p = bSplineCurve(10, 20, 100, 40, 30, 30, 20, 70);
//var out = "";
//for (var i = 0; i < p.length; i++) {
//    out += "(" + p.x[i] + ", " + p.y[i] + ")\n";
//}
