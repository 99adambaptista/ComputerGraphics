...
//write each time new items to list of lists of data
//undo goes back through the list
//try to use mouse for input, not 
...
function insert_shape(shape) {
    ...
    switch(shape) {
        case 0: //line
            ...
            //line.x = parseInt(document.getElementById("lx").value);
            //line.y = parseInt(document.getElementById("ly").value);
        ...
        case 1: //triangle
            ...
            //triangle.x = parseInt(document.getElementById("trix").value);
            //triangle.y = parseInt(document.getElementById("triy").value);
        ...
        case 2: //square
            ...
            //square.x = parseInt(document.getElementById("sx").value);
            //square.y = parseInt(document.getElementById("sy").value);
        ...
        case 3: //rectangle
            ...
            //rectangle.x = parseInt(document.getElementById("rx").value);
            //rectangle.y = parseInt(document.getElementById("ry").value);
        ...
        case 4: //circle
            ...
            //circle.x = parseInt(document.getElementById("cx").value);
            //circle.y = parseInt(document.getElementById("cy").value);
        ...
        case 5: //ellipse
            ...
            //ellipse.x = parseInt(document.getElementById("ex").value);
            //ellipse.y = parseInt(document.getElementById("ey").value);
        ...
        case 7: //poly-line
            ...
            // regular expression to check if any characters other
            // than 0-9 ","  ";" or a new line is entered
            var invalidChar = /[^\d, \n]/;
        ...
        case 8: //polygon
            ...
            //polygon.x = parseInt(document.getElementById("px").value);
            //polygon.y = parseInt(document.getElementById("py").value);
...
function set_points(shape_json) {
    ...
    switch (shape_json.obj) {
        ...
        case "curve":
            ...
            //rotates the curve from the center of the 4 points
...
function iter_shape_data() {
    ...
    //if (undo && shape_list.length != 0) {
    //    shape_list = undo_save.pop();
    //    undo = false;
    //}
}
...
function mouse_collision(shape_json) {
    ...
    //ellipse collision equation (from https://math.stackexchange.com/questions/2114895/point-ellipse-collision-test)
    if (shape_json.obj == "circle" || shape_json.obj == "ellipse") {
